...
// --------------------------------------------------------------------------------------
$TLS_htmltext_title['error']	= "アプリケーションエラー";
$TLS_htmltext['error'] 		= "<p>予期しないエラーが発生しました。".
                "イベントビューワ―か詳細ログを確認してください。</p>".
                "<p>障害の報告を歓迎します。我々の<a href='http://www.teamst.org'>website</a>を".
                "訪問してください。</p>";
...
検索は大文字と小文字を区別しません。 
検索結果は現在のテストプロジェクトからのテストケースのみを含みます。</p>
...
// requirements search
// ------------------------------------------------------------------------------------------
$TLS_htmltext_title['searchReq']	= "要件検索ページ";
$TLS_htmltext['searchReq'] 		= "<h2>目的:</h2>

<p>ナビゲーションのない検索文字列に従って検索を行います。
検索は大文字と小文字は区別しません。
検索結果は現在のテストプロジェクトの要件のみをふくみます。</p>
...
// ------------------------------------------------------------------------------------------
$TLS_htmltext_title['searchReqSpec']	= "要件仕様検索ページ";
$TLS_htmltext['searchReqSpec'] 		= "<h2>目的:</h2>

<p>ナビゲーションのない検索文字列に従って検索を行います。
検索は大文字と小文字は区別しません。
検索結果は現在のテストプロジェクトの要件仕様のみをふくみます。</p>
...
<ol>
    ...
    <li>必要なキーワードを選ぶか、左側にある値の '適用しない' を選んで下さい。</li>
    <li>検索ボタンをクリックして下さい。</li>
    <li>全ての条件に一致した要件仕様が表示されます。'タイトル'をクリックすることで要件を編集できます。</li>
</ol>

<h2>備考:</h2>

<p>- 現在のプロジェクト内の要件仕様のみが検索されます。<br>
- 検索は大文字小文字区別しません。<br>
- 空のフィールドは処理されません。</p>";
/* end contribution */
...
<p>本機能をつかうことで、単一の要件、要件仕様を持つ全ての要件、
テストプロジェクトの全ての要件を印刷することが出来ます。</p>

<h2>やってみましょう！:</h2>
<ol>
<li>
<p>表示したい要件の一部を選択し、要件、要件仕様、もしくはテストプロジェクトをクリックします。
そうすると印刷ページが表示されます。</p>
</li>
<li><p>ナビゲーション部にある「表示形式」を選択することで、HTML、OpenOffice WriterやMicosoft Word文書を
見ることが出来ます。
詳細は <span class=\"help\" onclick=\"javascript:open_help_window('printFilter',
'{$locale}');\">ヘルプ</span>を参照して下さい。</p>
</li>
<li><p>ブラウザの印刷機能を使うことで、情報を印刷することが出来ます。<br />
<i>備考: 右側のフレームのみを印刷してください。</i></p>
</li>
</ol>";
...
<li><b>OpenOffice Writer</b> - OpenOffice Writer用にレポートをエクスポート</li>
<li><b>OpenOffice Calc</b> - OpenOffice Calc用にレポートをエクスポート</li>
